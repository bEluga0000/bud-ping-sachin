...
export default function ChatSend() {
    ...
    return (
        <div style={{ maxHeight: "100%", display: "flex", padding: '0px 5px 5px 5px', gap: '5%' }}>
            ...
            <button style={{ width: "20%", fontSize: "1rem", borderRadius: '10px', outline: 'none', backgroundColor: "white", border: "1px solid black", cursor: "pointer" }} disabled={isDisable} onClick={()=>{setSendMsg("")}}>
